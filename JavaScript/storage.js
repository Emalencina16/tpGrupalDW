function inicializarLocalStorage() {
  if (!localStorage.getItem("salones")) {
    let salones = [
      ...
      { id: 11, nombre: "Salón Aurora", tipo:"Interior", capacidad: 150, direccion: "España 2369", precio: 15000, descripcion: "Espacio rodeado de palmeras y césped natural, ideal para celebraciones al aire libre con ambientación tropical. Cuenta con pérgolas, iluminación cálida y capacidad para 150 personas.", imagen: "../img/salones%20exterior/aurora.webp" },
      { id: 12, nombre: "Salón Zafiro", tipo:"Interior", capacidad: 130, direccion: "Urquiza 1557", precio: 18000, descripcion: "Salón estilo campestre con vistas panorámicas y una gran arboleda. Perfecto para bodas, eventos corporativos o reuniones familiares. Dispone de estacionamiento y carpa opcional.", imagen: "../img/salones%20exterior/zafiro.png" },
      { id: 13, nombre: "Salón Ébano", tipo:"Interior", capacidad: 90, direccion: "Batalla de Caseros 583", precio: 12000, descripcion: "Salón exterior rodeado de aromos y flores de estación, con un diseño elegante y romántico. Ofrece servicios de catering y decoración personalizada.", imagen: "../img/salones%20exterior/ebano.png" },
      { id: 14, nombre: "Salón Horizonte", tipo:"Interior", capacidad: 100, direccion: "Cochabamba 749", precio: 22000, descripcion: "Espacio moderno junto al río, con deck de madera, barra al aire libre y vista privilegiada del atardecer. Ideal para eventos sociales y fiestas exclusivas.", imagen: "../img/salones%20exterior/horizonte.png" },
      { id: 15, nombre: "Salón Prisma", tipo:"Interior", capacidad: 200, direccion: "Falso 123", precio: 16000, descripcion: "Ambiente rústico y natural con amplios espacios verdes, lago artificial y zona de juegos. Ideal para eventos diurnos con actividades al aire libre.", imagen: "../img/salones%20exterior/prisma.png" }
    ];
