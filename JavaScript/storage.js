export function inicializarLocalStorage() {
  if (!localStorage.getItem("salones")) {
    var salones = [
      { id: 1, nombre: "Salón Encanto", capacidad: 120, direccion: "Av. Sarmiento 1123", precio: 25000, descripcion: "Un salón versátil con un toque de elegancia y calidez. Ideal para celebraciones sociales, cuenta con un ambiente cómodo y detalles encantadores que se adaptan a distintos estilos de eventos. Perfecto para quienes buscan un espacio con personalidad.", tipo: "interior", imagen: "../img/salones%20interior/salonEncanto.png" },
