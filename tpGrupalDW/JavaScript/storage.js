function inicializarLocalStorage() {
  if (!localStorage.getItem("salones")) {
    let salones = [
      ...
      { id: 16, nombre: "Salón Coliseo", tipo: "Pileta", capacidad: 40, direccion: "Garrigo 4322, Crespo, Entre Ríos", precio: 27000, descripcion: "Elegante salón con pileta al aire libre, ideal para eventos sociales con estilo en un entorno relajado.", imagen: "../img/salones pileta/coliseo.jpg" },
      { id: 17, nombre: "Salón El Espejo", tipo: "Pileta", capacidad: 25, direccion: "Las chacras 1327, Villa Gesell, Buenos Aires", precio: 22000, descripcion: "Ambiente moderno con piscina y áreas verdes. Perfecto para celebraciones íntimas en verano.", imagen: "../img/salones pileta/espejo.jpg" },
      { id: 18, nombre: "Salón La Bodega", tipo: "Pileta", capacidad: 60, direccion: "Los cardenales 3256, Carlos Paz, Córdoba", precio: 30000, descripcion: "Gran espacio con pileta central y zona chill out. Ideal para grandes eventos o fiestas nocturnas.", imagen: "../img/salones pileta/bodega.jpg" },
      { id: 19, nombre: "Salón El Remanso", tipo: "Pileta", capacidad: 30, direccion: "Av Ejército 1567, Colonia Avellaneda, Entre Ríos", precio: 20000, descripcion: "Salón acogedor con piscina climatizada. Excelente opción para eventos familiares o infantiles.", imagen: "../img/salones pileta/remanso.jpg" },
      { id: 20, nombre: "Salón El Refugio", tipo: "Pileta", capacidad: 45, direccion: "Echague 879, Paraná, Entre Ríos", precio: 25000, descripcion: "Espacio moderno con pileta y parrilla. Combinación ideal para celebraciones al aire libre.", imagen: "../img/salones pileta/refugio.jpg" }
